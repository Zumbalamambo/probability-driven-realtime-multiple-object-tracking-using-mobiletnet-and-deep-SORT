...
if __name__ == '__main__':
    ...
    tests_list = ['./MOT15_Train/squeeze_v1_0/', './MOT15_Train/mobilenetssd/', './MOT15_Train/mobilenetv2_ssdlite/']
    #'./MOT15_Test/yolov3_tiny/', './MOT15_Test/mobilenetssd/', './MOT15_Test/mobilenetv2_ssdlite/', './MOT15_Test/squeeze_v1_0/']
    case_list = ['vanilla', 'vanilla_down_sample', 'skip2', 'skip2_down_sample', 'skip2_with_prob', 'skip2_with_prob_down_sample', 'skip3', 'skip3_down_sample', 'skip3_with_prob', 'skip3_with_prob_down_sample', 'skip5', 'skip5_down_sample', 'skip5_with_prob', 'skip5_with_prob_down_sample', 'skip7', 'skip7_down_sample', 'skip7_with_prob', 'skip7_with_prob_down_sample']
